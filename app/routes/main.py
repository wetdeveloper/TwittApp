...
@main_bp.route('/userpage/<string:username>/', methods=["GET"])
@main_bp.route('/userpage/', methods=["GET"])
...
@main_bp.route('/UploadProfilePicture',methods=['POST'])
def UploadProfPic():
...
@main_bp.route('/home/twitts/twitt_it/',methods=['POST','GET'])
def TwittIt():
...
@main_bp.route('/home/twitts/<int:start>', methods=['GET'])
@main_bp.route('/home/twitts/', defaults={'start': 0}, methods=['GET'])
def twitts(start):
...
@main_bp.route("/home/twitts/retwitt/",methods=['POST'])
def ReTwitt():
...
@main_bp.route('/home/twitts/like_twitt/',methods=['POST'])
def LikeTwitt():
    if request.method=='POST':
        userid=current_user.id
        twittid=request.form['twittid']
...
@main_bp.route("/home/twitts/twitt/<int:twittid>/likers/<string:username>/",methods=["GET"])
@main_bp.route("/userpage/twitt/<int:twittid>/likers/<string:username>/",methods=["GET"])
...
@main_bp.route('/home/twitts/see_comments/<int:twittid>/<int:start>',methods=['GET'])
@main_bp.route('/home/twitts/see_comments/',methods=['GET'],defaults={'twittid':1,'start':0})
...
@main_bp.route('/home/twitts/like_comment/',methods=['POST'])
def LikeComment():
    if request.method=='POST':
        userid=current_user.id
        twittid=request.form['twittid'] 
...
@main_bp.route('/home/twitts/see_comments/Likers/<int:twittid>/<int:commentid>',methods=['GET'])
...
@main_bp.route('/home/twitts/leave_comments/',methods=['POST'])
def LeaveComment():
...
@main_bp.route('/home/twitts/see_comment_replays/<int:commentid>',methods=['GET'])
...
@main_bp.route('/home/twitts/leave_comment_replay/',methods=['POST'])
...
@main_bp.route('/home/twitts/see_comments/like_comment_replays/',methods=['POST'])
...
@main_bp.route('/home/twitts/see_replay_on_replays/<int:twittid>/<int:id>/<int:comment_replay_id>/<int:request_from>',methods=['GET'])
@main_bp.route('/home/twitts/see_replay_on_replays/',methods=['GET'],defaults={'twittid':1,'id':1,'comment_replay_id':1})
...
@main_bp.route('/home/twitts/see_replay_on_replays/likereplaysonreplay/',methods=['POST'])
...
@main_bp.route('/home/twitts/leave_replay_on_replays/',methods=['POST'])
...
@main_bp.route('/myip',methods=['GET'])
def MyIp():
...
@main_bp.route('/home/twitts/direct',methods=['POST'])
...
@main_bp.route('/userpage/<string:username>/followers/',methods=['GET'])
...
@main_bp.route('/user/<string:username>/followings/',methods=['GET'])
...
@main_bp.route('/home/twitts/follow/',methods=['POST'])
def Follow():
    if request.method=='POST':
        if current_user.is_authenticated:
...
@main_bp.route('/home/twitts/unfollow/',methods=['POST'])
def UnFollow():
    if request.method=='POST':
        if current_user.is_authenticated:
...
@main_bp.route('/home/twitts/search-user/',methods=['GET'])
def Search():
